...
export class MeshCentralFileManager {
  ...
  private handleFindFileMessage(message: any): void {
    ...
    if (r === null) {
      ...
      if (
        isStaleSearch &&
        (this.isPreparingNewSearch || this.pendingSearchRequestId !== null || this.searchDebounceTimer !== null)
      ) {
        return;
      }
          ...
          if (this.pendingSearchRequestId) {
            ...
            const cancellationPromise = new Promise<void>(resolveCancellation => {
              ...
              const checkInterval = setInterval(() => {
                if (!this.pendingRequests.has(cancelRequestId) && !this.searchResults.has(cancelRequestId)) {
  ...
  isSearchActive(): boolean {
    return this.isPreparingNewSearch || this.pendingSearchRequestId !== null || this.searchDebounceTimer !== null;
  }
