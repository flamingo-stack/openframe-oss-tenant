...
/**
 * Тимчасовий тест для перевірки MongoDB підключення та DBQuery
 */
@Slf4j
public class MongoDBConnectionTest extends BaseTest {
    ...
    protected void setupTest(TestInfo testInfo) {
        ...
        // Ініціалізуємо MongoDB підключення
        mongoConnection = MongoDBConnection.fromConfig();
        
        // Зберігаємо з'єднання в ThreadSafeTestContext
    ...
    void shouldConnectToMongoDBSuccessfully() {
        ...
        try {
            // Перевіряємо чи підключення працює
