...
register_tool \
    ...
    '[{"url": "http://openframe-gateway.microservices.svc", "port": "8100", "type": "API"}]' \
    "" \
    "" \
    "" \
    "Gateway" \
...
register_tool \
    ...
    '[{"url": "http://openframe-api.microservices.svc", "port": "8095", "type": "API"}]' \
    "" \
    "" \
    "" \
    "API Gateway" \
...
register_tool \
    ...
    '[{"url": "http://openframe-stream.microservices.svc", "port": "8091", "type": "API"}]' \
    "" \
    "" \
    "" \
    "Stream Processing" \
...
register_tool \
    ...
    '[{"url": "http://openframe-management.microservices.svc", "port": "8096", "type": "API"}]' \
    "" \
    "" \
    "" \
    "Management" \
...
register_tool \
    ...
    '[{"url": "http://openframe-config.microservices.svc", "port": "8090", "type": "API"}]' \
    "" \
    "" \
    "" \
    "Configuration" \
...
register_tool \
    ...
    '[{"url": "http://kafka-ui.192.168.100.100.nip.io", "port": "80", "type": "DASHBOARD"}, {"url": "http://kafka.datasources", "port": "9092", "type": "BROKER"}, {"url": "http://kafka.datasources", "port": "29092", "type": "INTERNAL"}]' \
    "" \
    "" \
    "" \
    "Message Broker" \
...
register_tool \
    ...
    '[{"url": "http://zookeeper.datasources", "port": "2181", "type": "COORDINATOR"}]' \
    "" \
    "" \
    "" \
    "Service Discovery" \
...
register_tool \
    ...
    '[{"url": "https://openframe-nifi.192.168.100.100.nip.io", "port": "443", "type": "DASHBOARD"}, {"url": "https://openframe-nifi.datasources", "port": "9096", "type": "API"}]' \
    "openframe" \
    "password123456789" \
    "" \
    "Data Integration" \
...
register_tool \
    ...
    '[{"url": "mongodb://mongodb.datasources", "port": "27017", "type": "DATABASE"}, {"url": "http://mongo-express.192.168.100.100.nip.io", "port": "80", "type": "DASHBOARD"}]' \
    "openframe" \
    "password123456789" \
    "" \
    "NoSQL Database" \
...
register_tool \
    ...
    '[{"url": "redis://redis-headless.datasources", "port": "6379", "type": "DATABASE"}]' \
    "" \
    "" \
    "" \
    "In-Memory Database" \
...
register_tool \
    ...
    '[{"url": "cassandra://cassandra.datasources", "port": "9042", "type": "DATABASE"}]' \
    "" \
    "" \
    "" \
    "NoSQL Database" \
...
register_tool \
    ...
    '[{"url": "http://pinot-controller.datasources.svc", "port": "9000", "type": "CONTROLLER"},{"url": "http://pinot-broker.datasources.svc", "port": "8099", "type": "BROKER"},{"url": "http://pinot-server.datasources.svc", "port": "8097", "type": "SERVER"}]' \
    "" \
    "" \
    "" \
    "Analytics Database" \
