...
function integrated_tools_fleet_deploy() {
  echo "Deploying Fleet" &&
    kubectl -n integrated-tools apply -k ${ROOT_REPO_DIR}/manifests/integrated-tools/fleet
}
...
function integrated_tools_fleet_delete() {
  echo "Deleting Fleet"
  kubectl -n integrated-tools delete -k ${ROOT_REPO_DIR}/manifests/integrated-tools/fleet
}
...
function integrated_tools_authentik_deploy() {
  ...
  echo "Deploying Authentik" &&
    kubectl -n integrated-tools apply -k ${ROOT_REPO_DIR}/manifests/integrated-tools/authentik/manifests
...
function integrated_tools_authentik_delete() {
  echo "Deleting Authentik" &&
    kubectl -n integrated-tools delete -k ${ROOT_REPO_DIR}/manifests/integrated-tools/authentik/manifests
}

# MESHCENTRAL
function integrated_tools_meshcentral_deploy() {
  echo "Deploying MeshCentral" &&
    kubectl -n integrated-tools apply -k ${ROOT_REPO_DIR}/manifests/integrated-tools/meshcentral
}
...
function integrated_tools_meshcentral_delete() {
  ...
  kubectl -n integrated-tools delete -k ${ROOT_REPO_DIR}/manifests/integrated-tools/meshcentral
}

# TACTICAL RMM
function integrated_tools_tactical_rmm_deploy() {
  echo "Deploying Tactical RMM"
  kubectl -n integrated-tools apply -k ${ROOT_REPO_DIR}/manifests/integrated-tools/tactical-rmm
}
...
function integrated_tools_tactical_rmm_delete() {
  ...
  kubectl -n integrated-tools delete -k ${ROOT_REPO_DIR}/manifests/integrated-tools/tactical-rmm
}
