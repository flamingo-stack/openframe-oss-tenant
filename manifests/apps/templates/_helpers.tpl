...
5. If deployment.saas.enabled → skip "openframe-gateway" "openframe-external-api" "openframe-stream" "openframe-config" "openframe-client" "openframe-api" "openframe-authorization-server" "ngrok-operator" "registration"
...
{{- else if and $oss $ossNgrok (eq $name "ingress-nginx") }}
  true
{{- else if and $saas (or (eq $name "openframe-gateway") (eq $name "openframe-external-api") (eq $name "openframe-stream") (eq $name "openframe-config") (eq $name "openframe-client") (eq $name "openframe-api") (eq $name "openframe-authorization-server") (eq $name "ngrok-operator") (eq $name "registration")) }}
  true
