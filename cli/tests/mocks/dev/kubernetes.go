...
func (m *MockKubernetesClient) GetServices(ctx context.Context, namespace string) ([]interfaces.ServiceInfo, error) {
...
func (m *MockKubernetesClient) GetService(ctx context.Context, namespace, serviceName string) (*interfaces.ServiceInfo, error) {
	services, exists := m.services[namespace]
	if !exists {
...
func (m *MockKubernetesClient) AddNamespace(namespace string) {
	...
	if m.services[namespace] == nil {
		m.services[namespace] = []interfaces.ServiceInfo{}
	}
}

// AddService adds a service to a namespace (for testing)
func (m *MockKubernetesClient) AddService(namespace string, service interfaces.ServiceInfo) {
	if m.services[namespace] == nil {
		m.services[namespace] = []interfaces.ServiceInfo{}
	}
...
func (m *MockKubernetesClient) ClearNamespaces() {
	m.namespaces = []string{}
	m.services = map[string][]interfaces.ServiceInfo{}
}
...
func (m *MockKubernetesClient) GetServicesByType(ctx context.Context, namespace, serviceType string) ([]interfaces.ServiceInfo, error) {
	services, err := m.GetServices(ctx, namespace)
	if err != nil {
		return nil, err
	}
	
	var filtered []interfaces.ServiceInfo
	for _, service := range services {
