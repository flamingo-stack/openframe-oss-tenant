...
// ClusterCommandService provides business logic for cluster commands
...
func (s *ClusterCommandService) cleanupK3dCluster(clusterName string, verbose bool) error {
...
func (s *ClusterCommandService) ShowClusterStatus(name string, detailed bool, skipApps bool, verbose bool) error {
	ctx := context.Background()
