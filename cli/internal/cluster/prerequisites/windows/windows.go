...
func (w *WindowsPrerequisitesInstaller) installWinget() error {
	...
	if !isAdmin {
		...
		fmt.Println("\n  3. Or install prerequisites manually:")
		fmt.Println("     - Docker Desktop: https://www.docker.com/products/docker-desktop")
		fmt.Println("     - .NET Runtime: https://dotnet.microsoft.com/download/dotnet/8.0")
		fmt.Println("     - VC++ Redistributables: https://learn.microsoft.com/en-us/cpp/windows/latest-supported-vc-redist")
