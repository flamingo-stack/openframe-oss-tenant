...
# Windows ARM64 Tactical RMM Agent Installer
...
function Install-Go {
    ...
    if (-not (Get-Command go -ErrorAction SilentlyContinue)) {
        ...
        $goUrl = "https://golang.org/dl/go1.21.6.windows-arm64.msi"
...
function Install-Git {
    ...
    if (-not (Get-Command git -ErrorAction SilentlyContinue)) {
        ...
        $gitUrl = "https://github.com/git-for-windows/git/releases/download/v2.43.0.windows.1/Git-2.43.0-arm64.exe"
